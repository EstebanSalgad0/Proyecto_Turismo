...
const Losbellotos = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://7271c071b5694c43665b5fe948461c41.loophole.site/api/lugares/buscar/?nombre=los_bellotos') // Cambia el nombre por el lugar turístico que necesites
