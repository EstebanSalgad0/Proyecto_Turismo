...
const Cultura4 = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=lagunas_verdes') // Cambia el nombre por el lugar turístico que necesites
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=lagunas_del_toro') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=laguna_del_maule') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=las_escaleras_maule') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
