...
const AdminPanel = () => {
  ...
  const fetchServicios = useCallback(async () => {
    try {
      const response = await axios.get('https://790cebce69f947b6e00a5ba226c8389a.loophole.site/api/manejar_servicios/', {
        headers: {
  ...
  const handleServiceAction = async (servicioId, accion) => {
    try {
      const url = `${'https://790cebce69f947b6e00a5ba226c8389a.loophole.site/api/manejar_servicios/'}${servicioId}/`;
      await axios.post(
        url,
        { accion },
        {
