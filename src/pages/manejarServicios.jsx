...
const AdminPanel = () => {
  ...
  const fetchServicios = useCallback(async () => {
    try {
      const response = await axios.get('https://7592368d4a4a082e991c1a8bde5360ba.loophole.site/api/manejar_servicios/', {
        headers: {
  ...
  const handleServiceAction = async (servicioId, accion) => {
    try {
      const url = `${'https://7592368d4a4a082e991c1a8bde5360ba.loophole.site/api/manejar_servicios/'}${servicioId}/`;
      await axios.post(
        url,
        { accion },
        {
