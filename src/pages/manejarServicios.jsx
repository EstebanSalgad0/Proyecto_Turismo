...
const AdminPanel = () => {
  ...
  const fetchServicios = useCallback(async () => {
    try {
      const response = await axios.get('https://49bdbb88728953fd028caea01d4c7dbd.loophole.site/api/manejar_servicios/', {
        headers: {
  ...
  const handleServiceAction = async (servicioId, accion) => {
    try {
      const url = `${'https://49bdbb88728953fd028caea01d4c7dbd.loophole.site/api/manejar_servicios/'}${servicioId}/`;
      await axios.post(
        url,
        { accion },
        {
