...
const Quinamavida = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://25248c994415a4f2d05d93c80ee1e747.loophole.site/api/lugares/buscar/?nombre=quinamavida') // Cambia el nombre por el lugar turístico que necesites
