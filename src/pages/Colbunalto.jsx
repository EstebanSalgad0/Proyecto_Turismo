...
const Colbunalto = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://8600a7b2b57e7a9a11c9a6510b6a0f48.loophole.site/api/lugares/buscar/?nombre=colbun_alto') // Cambia el nombre por el lugar turístico que necesites
