...
const Colbunalto = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://9616ee88920d1f74470820c9ce8b36a3.loophole.site/api/lugares/buscar/?nombre=colbun_alto') // Cambia el nombre por el lugar turístico que necesites
