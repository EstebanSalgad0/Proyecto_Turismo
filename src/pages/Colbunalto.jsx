...
const Colbunalto = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://790cebce69f947b6e00a5ba226c8389a.loophole.site/api/lugares/buscar/?nombre=colbun_alto') // Cambia el nombre por el lugar turístico que necesites
