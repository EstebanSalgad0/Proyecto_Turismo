...
const Cultura4 = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE_URL}/api/lugares/buscar/?nombre=volcan_san_pedro_pablo`) // Cambia el nombre por el lugar turístico que necesites
    ...
    fetch(`${API_BASE_URL}/api/lugares/buscar/?nombre=laguna_dial`) // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch(`${API_BASE_URL}/api/lugares/buscar/?nombre=banos_socorro`) // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
