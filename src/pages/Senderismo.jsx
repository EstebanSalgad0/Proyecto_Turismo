...
const Cultura4 = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=volcan_san_pedro_pablo') // Cambia el nombre por el lugar turístico que necesites
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=laguna_dial') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=banos_socorro') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
