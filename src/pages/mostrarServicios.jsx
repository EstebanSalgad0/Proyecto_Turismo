    ...
    const fetchServicios = async () => {
      try {
        const response = await axios.get(
          'https://59d8706a9084d7426b317e87f91aa310.loophole.site/api/listar_servicios_aceptados/'
        );
              ...
              <div key={servicio.id} className="service-container">
                ...
                >
                  ...
                  <div className="image-gallery">
                    {servicio.imagen ? (
                      <img
                        src={`${'https://59d8706a9084d7426b317e87f91aa310.loophole.site'}${servicio.imagen}`}
                  ...
                  {expandedServicio === servicio.id && (
                    <>
                      ...
                      >
                        ...
                        {servicio.imagen2 && (
                          <img
                            src={`${'https://59d8706a9084d7426b317e87f91aa310.loophole.site'}${servicio.imagen2}`}
                        ...
                        {servicio.imagen3 && (
                          <img
                            src={`${'https://59d8706a9084d7426b317e87f91aa310.loophole.site'}${servicio.imagen3}`}
                        ...
                        {servicio.imagen4 && (
                          <img
                            src={`${'https://59d8706a9084d7426b317e87f91aa310.loophole.site'}${servicio.imagen4}`}
