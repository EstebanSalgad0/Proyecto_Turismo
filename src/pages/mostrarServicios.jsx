    ...
    const fetchServicios = async () => {
      try {
        const response = await axios.get(
          'https://25248c994415a4f2d05d93c80ee1e747.loophole.site/api/listar_servicios_aceptados/'
        );
              ...
              <div key={servicio.id} className="service-container">
                ...
                >
                  ...
                  <div className="image-gallery">
                    {servicio.imagen ? (
                      <img
                        src={`${'https://25248c994415a4f2d05d93c80ee1e747.loophole.site'}${servicio.imagen}`}
                  ...
                  {expandedServicio === servicio.id && (
                    <>
                      ...
                      >
                        ...
                        {servicio.imagen2 && (
                          <img
                            src={`${'https://25248c994415a4f2d05d93c80ee1e747.loophole.site'}${servicio.imagen2}`}
                        ...
                        {servicio.imagen3 && (
                          <img
                            src={`${'https://25248c994415a4f2d05d93c80ee1e747.loophole.site'}${servicio.imagen3}`}
                        ...
                        {servicio.imagen4 && (
                          <img
                            src={`${'https://25248c994415a4f2d05d93c80ee1e747.loophole.site'}${servicio.imagen4}`}
