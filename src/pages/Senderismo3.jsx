...
const Cultura4 = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=las_cuevas') // Cambia el nombre por el lugar turístico que necesites
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=laguna_achibueno') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=piedras_altas') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch('http://www.visitacolbun.cl/api/lugares/buscar/?nombre=lago_colbun') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
