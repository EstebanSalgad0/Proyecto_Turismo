...
const Cultura4 = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://25248c994415a4f2d05d93c80ee1e747.loophole.site/api/lugares/buscar/?nombre=las_cuevas') // Cambia el nombre por el lugar turístico que necesites
    ...
    fetch('https://25248c994415a4f2d05d93c80ee1e747.loophole.site/api/lugares/buscar/?nombre=laguna_achibueno') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch('https://25248c994415a4f2d05d93c80ee1e747.loophole.site/api/lugares/buscar/?nombre=piedras_altas') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch('https://25248c994415a4f2d05d93c80ee1e747.loophole.site/api/lugares/buscar/?nombre=lago_colbun') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
