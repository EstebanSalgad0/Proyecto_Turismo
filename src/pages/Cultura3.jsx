...
const Cultura4 = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://c5532462f07503dfc9b0bb1d4395a98c.serveo.net/api/lugares/buscar/?nombre=iglesia_panimavida') // Cambia el nombre por el lugar turístico que necesites
    ...
    fetch('https://c5532462f07503dfc9b0bb1d4395a98c.serveo.net/api/lugares/buscar/?nombre=las_tacitas') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch('https://c5532462f07503dfc9b0bb1d4395a98c.serveo.net/api/lugares/buscar/?nombre=embotelladora') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch('https://c5532462f07503dfc9b0bb1d4395a98c.serveo.net/api/lugares/buscar/?nombre=estacion_tren') // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
