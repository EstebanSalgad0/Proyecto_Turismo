...
const Cultura4 = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE_URL}/api/lugares/buscar/?nombre=piedra_del_indio`) // Cambia el nombre por el lugar turístico que necesites
    ...
    fetch(`${API_BASE_URL}/api/lugares/buscar/?nombre=mirador_vizcachas`) // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
    ...
    fetch(`${API_BASE_URL}/api/lugares/buscar/?nombre=balnearios_machicura`) // Cambia el nombre por el lugar turístico que necesites
    .then(response => response.json())
    .then(data => {
