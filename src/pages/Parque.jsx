...
import '../styles/Parque.css?v=1.2' // Estilos específicos para el componente
    ...
    <div className={`index-container ${darkMode ? 'dark' : ''}`}>
      ...
      <div className="hero10">
        <div className="hero-content10">
          <h5>Parques y vida salvaje</h5>
          <h1>Parque nacional Guaiquivilo</h1>
