...
class RegisterView(APIView):
    def post(self, request):
        ...
        try:
            ...
            activation_url = f"https://790cebce69f947b6e00a5ba226c8389a.loophole.site{verification_link}"
...
class RequestPasswordResetView(APIView):
    def post(self, request):
        ...
        if user:
            ...
            fixed_domain = "https://790cebce69f947b6e00a5ba226c8389a.loophole.site"
